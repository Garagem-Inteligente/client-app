      ...
      <div class="page-content-wrapper min-h-screen py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="bg-gray-800 rounded-xl p-6 space-y-6 shadow-xl">
            ...
            <!-- Success Alert -->
            <AAlert v-if="successMessage" type="success" :message="successMessage" />
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div
                  v-if="totalCost > 0"
                  class="md:col-span-2 bg-blue-500/10 border border-blue-500/30 rounded-lg p-4"
                >
                ...
                <!-- Fotos Antes/Depois -->
                <div
                  class="md:col-span-2 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-lg p-4"
                >
                  <div class="flex items-center space-x-2 mb-4">
                    ...
                    <span class="text-sm font-medium text-purple-300"
                      >📸 Fotos Antes/Depois (Opcional)</span
                    >
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p class="text-xs text-gray-500 mt-1">
                        Estado da peça/problema antes do reparo
                      </p>
                      ...
                      <transition name="fade">
                        <div v-if="formData.beforePhoto" class="mt-3 relative group">
                          <div
                            class="relative overflow-hidden rounded-lg border-2 border-red-500 bg-gray-900"
                          >
                            <img
                    ...
                    <div>
                      ...
                      <p class="text-xs text-gray-500 mt-1">
                        Estado da peça após o reparo concluído
                      </p>
                      ...
                      <transition name="fade">
                        <div v-if="formData.afterPhoto" class="mt-3 relative group">
                          <div
                            class="relative overflow-hidden rounded-lg border-2 border-green-500 bg-gray-900"
                          >
                            <img
                ...
                >
                  ...
                  <p class="text-xs text-gray-400 mb-3">
                    📎 Anexe notas fiscais, comprovantes ou outros documentos relacionados à
                    manutenção. Você pode adicionar até 5 arquivos (imagens ou PDFs de até 10MB
                    cada).
                    <span class="block mt-1 text-yellow-400"
                      >💡 Dica: PDFs grandes? Use um compressor online antes de anexar.</span
                    >
                  </p>
                  <MFileUpload
                    ref="fileUploadRef"
              ...
              <div class="flex justify-end space-x-4">
                <ion-button fill="outline" @click="handleCancel" :disabled="loading">
                  Cancelar
                </ion-button>
                <ion-button type="submit" :disabled="loading || !isFormValid">
    ...
    try {
      ...
      if (image.dataUrl) {
        ...
        if (photoType === 'before') {
          ...
          logger.debug(
            '✅ beforePhoto atualizado:',
            formData.value.beforePhoto.substring(0, 50) + '...',
          );
        } else {
          formData.value.afterPhoto = image.dataUrl;
          logger.debug(
            '✅ afterPhoto atualizado:',
            formData.value.afterPhoto.substring(0, 50) + '...',
          );
        }
