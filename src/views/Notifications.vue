...
const getNotificationTypeLabel = (type: NotificationType) => {
  const labels = {
    ...
    insurance: 'Seguro',
    system: 'Sistema',
    job_order_approval: 'Aprovação de Ordem',
    review_response: 'Resposta da Oficina'
  }
  return labels[type]
}
...
const getNotificationIcon = (type: NotificationType) => {
  const icons = {
    ...
    job_order_approval: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
    review_response: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z'
  }
  return icons[type]
}
</script>
