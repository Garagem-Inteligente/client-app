    ...
    <ion-content :fullscreen="true" class="app-content">
      ...
      <div class="container page-content-wrapper dashboard-container">
        ...
        <div class="quick-actions-section">
          ...
          <div class="quick-actions-grid grid-responsive">
            <!-- Registrar Manutenção -->
            <button @click="handleNavigation('/tabs/maintenance/new')" class="quick-action-btn">
            ...
            <!-- Adicionar Veículo -->
            <button @click="handleNavigation('/tabs/vehicle/new')" class="quick-action-btn">
            ...
            <!-- Ver Histórico -->
            <button @click="handleNavigation('/tabs/maintenance')" class="quick-action-btn">
            ...
            <!-- Meus Veículos -->
            <button @click="handleNavigation('/tabs/vehicles')" class="quick-action-btn">
        ...
        <div v-if="overdueCount > 0" class="alert-danger">
          <div class="alert-content">
            ...
            <button class="alert-btn" @click="$router.push('/tabs/vehicles')">Ver detalhes</button>
          </div>
        </div>
