      ...
      <div class="page-content-wrapper">
        ...
        <ion-card v-else-if="vehiclesStore.error">
          <ion-card-content class="error-state">
            ...
            <ion-button @click="vehiclesStore.fetchVehicles()"> Tentar Novamente </ion-button>
          </ion-card-content>
        </ion-card>
        ...
        <div v-else-if="vehiclesStore.vehicles.length === 0" class="empty-state-container">
          <div class="empty-state">
            ...
            <p>
              Comece adicionando seu primeiro veículo e mantenha um histórico completo de
              manutenções
            </p>
...
<script setup lang="ts">
  ...
  const filteredVehicles = computed(() => {
    ...
    return vehiclesStore.vehicles.filter((vehicle) => vehicle.vehicleType === selectedFilter.value);
  });
...
<style scoped>
  ...
  .empty-category-card:hover {
    ...
    box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4), 0 0 40px rgba(129, 140, 248, 0.2);
  }
  ...
  .vehicle-card:hover {
    transform: translateY(-4px);
    border-color: rgba(129, 140, 248, 0.4);
    box-shadow: 0 24px 48px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(129, 140, 248, 0.3),
  ...
  .vehicle-card:hover .fuel-chip {
    ...
    border-color: rgba(129, 140, 248, 0.6);
    transform: translateY(-2px);
    box-shadow: 0 6px 16px rgba(129, 140, 248, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.15);
  }
  ...
  ion-fab-button {
    ...
    --box-shadow: 0 8px 24px -4px rgba(59, 130, 246, 0.5), 0 4px 12px -2px rgba(0, 0, 0, 0.3);
    --transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    width: 56px;
    height: 56px;
  }
  ...
  ion-fab-button:hover {
    --box-shadow: 0 12px 32px -6px rgba(59, 130, 246, 0.6), 0 6px 16px -3px rgba(0, 0, 0, 0.4);
