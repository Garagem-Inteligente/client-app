<template>
  <ion-page>
    ...
    <ion-tabs>
      ...
      <ion-tab-bar slot="bottom" class="premium-tab-bar mobile-only">
        ...
        >
          <div class="tab-wrapper">
            ...
            <div class="icon-container">
              ...
              <ion-icon aria-hidden="true" :icon="tab.icon" class="tab-icon" />
            </div>
...
<script setup lang="ts">
  ...
  import { home, car, construct, person } from 'ionicons/icons';
  import DesktopSidebar from '@/components/organisms/DesktopSidebar.vue';
...
<style scoped>
  ...
  .premium-tab-button:nth-child(2) {
    animation-delay: 0.05s;
  }
  .premium-tab-button:nth-child(3) {
    animation-delay: 0.1s;
  }
  .premium-tab-button:nth-child(4) {
    animation-delay: 0.15s;
  }
  .premium-tab-button:nth-child(5) {
