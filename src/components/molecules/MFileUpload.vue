  ...
  <div class="file-upload-container">
    ...
    >
      ...
      <div class="upload-content">
        ...
        <p class="upload-hint">Máximo {{ maxFiles }} arquivo(s) - {{ maxSize }}MB cada</p>
      </div>
    </div>
      ...
      >
        ...
        <div class="file-actions">
          ...
          <div v-else-if="file.error" class="action-buttons">
            <ion-button fill="solid" size="small" color="danger" @click="removeFile(index)">
...
<script setup lang="ts">
  import { ref } from 'vue';
  import { IonIcon, IonProgressBar, IonButton } from '@ionic/vue';
  import {
    cloudUploadOutline,
    documentTextOutline,
    imageOutline,
  ...
  const processFiles = async (filesList: File[]) => {
    ...
    if (totalFiles > props.maxFiles) {
      uploadError.value = `⚠️ Você selecionou ${
        filesList.length
      } arquivo(s), mas só é possível adicionar mais ${
        props.maxFiles - files.value.length
