  ...
  <section class="c-login-card" aria-labelledby="login-title">
    ...
    <form @submit.prevent="$emit('submit')" class="c-login-form" novalidate>
      ...
      <div class="c-login-form__actions">
        <button type="button" @click="$emit('forgot-password')" class="c-login-form__link">
          Esqueceu a senha?
        </button>
      </div>
      ...
      <!-- Submit Button -->
      <button type="submit" :disabled="loading" class="c-login-form__submit" :aria-busy="loading">
        <ion-spinner
          v-if="loading"
          name="crescent"
...
<script setup lang="ts">
  ...
  import { mailOutline, lockClosedOutline, alertCircle, personAddOutline } from 'ionicons/icons';
