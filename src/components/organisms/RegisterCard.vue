<template>
  <article class="c-register-card">
    ...
    <header class="c-register-card__header">
      ...
      <p class="c-register-card__subtitle">
    ...
    <form @submit.prevent="$emit('submit')" class="c-register-card__form">
      ...
      <div class="c-register-card__form-group">
        <label for="register-name" class="c-register-card__label">
          <ion-icon
            :icon="personOutline"
            class="c-register-card__label-icon"
          ></ion-icon>
          Nome Completo
        </label>
      ...
      <div class="c-register-card__form-group">
        ...
        <div
          v-if="modelValue.password"
          class="c-register-card__password-strength"
        >
          ...
          <span class="c-register-card__strength-text">{{
      ...
      <div v-if="error" class="c-register-card__error-message">
        <ion-icon
          :icon="alertCircle"
          class="c-register-card__error-icon"
        ></ion-icon>
        <span>{{ error }}</span>
      </div>
      ...
      <div v-if="successMessage" class="c-register-card__success-message">
        <ion-icon
          ...
          class="c-register-card__success-icon"
        ></ion-icon>
    ...
    <button @click="$emit('login')" class="c-register-card__secondary-button">
      <ion-icon
        :icon="logInOutline"
        class="c-register-card__button-icon"
      ></ion-icon>
      Já tenho uma conta
    </button>
  </article>
